...
const Footer = () => {
  ...
  return (
    <footer className="bg-background-light dark:bg-background-dark border-t border-primary/20 dark:border-primary/30 sticky bottom-0">
      <nav className="flex justify-around p-2">
        <button
          className="flex flex-col items-center gap-1 p-2 rounded-lg hover:bg-primary/10 dark:hover:bg-primary/20 w-1/4 text-content-light/70 dark:text-content-dark/70"
        ...
        <button
          className="flex flex-col items-center gap-1 p-2 rounded-lg bg-primary/20 dark:bg-primary/30 w-1/4 text-primary"
